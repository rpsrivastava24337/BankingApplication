...
<body>
	...
	AccountBean ab2 = (AccountBean) application.getAttribute("abean2");
	AccountBean ab3 = (AccountBean) application.getAttribute("abean3");
	%>
	<div class="result">
		<h4>Money Transfer Successfully !!!</h4>
		<table>
			<tr>
				<th>Your Acc.No</th>
				<th>Your Balance</th>
