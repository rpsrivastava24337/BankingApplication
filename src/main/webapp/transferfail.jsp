    ...
    <div>
       ...
       String msg = (String)request.getAttribute("msg");
        ...
        <div  class="container newaccform">
          <fieldset>
              <legend>Money Transfer Form</legend>
              <p><%=msg %></p>
              <form action="transfer" method="post">
                 <label >SENDER Account No:</label>
        <input type="text" name="accno1" required><br>
        
        <label >SENDER Username:</label>
        <input type="text" name="uname1" required><br>
    
        <label>SENDER Password:</label>
        <input type="password"  name="pwd1" required><br>
        
        <label >RECIVER Account No:</label>
        <input type="text" name="accno2" required><br>
